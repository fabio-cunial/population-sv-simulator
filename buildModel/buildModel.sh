#!/bin/bash
#
REPEATMASKER_FILE="./input/repeats/hg19.fa.out.cleaned"
REPEATMASKER_FILE_NROWS="$(wc -l < ${REPEATMASKER_FILE})"
TRF_FILE="./input/repeats/hg19.trf.bed.cleaned"
TRF_FILE_NROWS="$(wc -l < ${TRF_FILE})"
SEGDUPS_FILE="./input/repeats/segdups.txt"
SEGDUPS_FILE_NROWS="$(( $(wc -l < ${SEGDUPS_FILE}) - 1))"
GNOMADSV_FILE="./input/gnomad_v2.1_sv.sites.vcf"
ONLY_PASS="1"
OUTPUT_DIR="./output"
VERBOSE="1"
